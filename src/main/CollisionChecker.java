            ...
            if (gp.obj[i] != null) {
                ...
                switch (entity.direction) {
                    case "up":
                        ...
                        if (entity.soildArea.intersects(gp.obj[i].soildArea)) {
                ...
                gp.obj[i].soildArea.x = gp.obj[i].solidAreaDefaultX;
                gp.obj[i].soildArea.y = gp.obj[i].solidAreaDefaultX;
